package fr.mrkeesler.mariobros.Scenes;
...
public class Hud implements Disposable {
    ...
    public Hud(SpriteBatch sb){
        ...
        this.countdownLabel = new Label(String.format("%03d",worldTimer), new Label.LabelStyle(new BitmapFont(), Color.WHITE));
        this.scoreLabel = new Label(String.format("%06d",score), new Label.LabelStyle(new BitmapFont(), Color.WHITE));
